...
Convolutional Neural Network (CNN) – A classic approach for image classification.

Vision Transformer (ViT) – A transformer-based architecture that treats images as sequences of patches.
